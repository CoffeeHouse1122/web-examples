...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function u(e, t, r, i, o, s) {
    return (
      (r = (parseFloat(r || 0) - parseFloat(e || 0)) * o),
      (i = (parseFloat(i || 0) - parseFloat(t || 0)) * s),
      Math.sqrt(r * r + i * i)
    );
  }
  function c(e) {
  ...
  function y(e) {
    ...
    if (
      ...
      for (
        i = e.getAttribute("points").match(l) || [],
          "polygon" === h && i.push(i[0], i[1]),
          t = 0,
          s = 2;
        s < i.length;
        s += 2
  ...
  function x(e, t) {
    ...
    return (
      s < 0 && (s = i.indexOf(" ")),
      t < (i = s < 0 ? t : parseFloat(i.substr(0, s)) || 1e-5) && (i = t),
      [Math.max(0, -o), Math.max(0, i - o)]
    );
  }
  ((e = _gsScope._gsDefine.plugin({
    ...
    init: function (e, t, r, i) {
      ...
      if (!w)
        return (
          (window.location.href =
            "http://" + m + S + "?plugin=" + C + "&source=codepen"),
          !1
        );
      var o,
        s,
      ...
      return (
        ...
        -1 === (u = h.indexOf(" "))
          ? ((l = void 0 !== d ? d + "" : h), (g = h))
          : ((l = h.substr(0, u)), (g = h.substr(u + 1))),
        (l = -1 !== l.indexOf("%") ? (parseFloat(l) / 100) * f : parseFloat(l)),
        (s =
          (g =
            -1 !== g.indexOf("%") ? (parseFloat(g) / 100) * f : parseFloat(g)) <
          l
            ? [g, l]
            : [l, g]),
        (this._length = c + 10),
